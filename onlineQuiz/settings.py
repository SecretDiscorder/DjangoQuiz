...
SECRET_KEY = 'django-insecure-kupu90+33$1-vu@(=xl9&eu-g=3y3zt%2y)zq_j7m@jk)#v81#'
...
SESSION_ENGINE = 'django.contrib.sessions.backends.db'  # Ganti dengan engine sesi yang Anda gunakan
